...
\multicolumn{[INSERTLASTYEARPLUSTHREE]}{|c|}{\cellcolor{\SectionBannerColor}\color{\SectionBannerFontColor}\TaskCategoryFontstyle{\FundedFteTitleText}}\\
...
\multicolumn{2}{|l}{\TotalWorkEffortFontstyle{\color{\TotalWorkEffortFontColor}\\[INSERTTOTALFUNDEDFTETITLE]}} [INSERTLISTOFANNUALFUNDEDTOTALS] & \multicolumn{1}{c|}{\color{\TotalWorkEffortFontColor}[INSERTFUNDEDTOTALOVERYEAR]}\\

% ==============================================   UNFUNDED FTEs
%---- banner for the Work Effort NOT Funded By This Proposal section 
\multicolumn{[INSERTLASTYEARPLUSTHREE]}{|c|}{\cellcolor{\SectionBannerColor}\color{\SectionBannerFontColor}\SectionBannerFontstyle{\UnfundedFteTitleText}}\\
...
\arrayrulecolor{lightgray!60}\hline\arrayrulecolor{black}
\multicolumn{2}{|l}{\TotalWorkEffortFontstyle{\color{\TotalWorkEffortFontColor}\\[INSERTTOTALUNFUNDEDFTETITLE]}} [INSERTLISTOFANNUALUNFUNDEDTOTALS] & \multicolumn{1}{c|}{\color{\TotalWorkEffortFontColor}[INSERTUNFUNDEDTOTALOVERYEAR]}\\

% ==============================================   FUNDED + UNFUNDED FTEs
%--- both FUNDED and UNFUNDED work efforts
\multicolumn{[INSERTLASTYEARPLUSTHREE]}{|c|}{\cellcolor{\SectionBannerColor}\color{\SectionBannerFontColor}\SectionBannerFontstyle{BothFteTitleText}}\\
...
\arrayrulecolor{lightgray!60}\hline\arrayrulecolor{black}
\multicolumn{2}{|l}{\TotalWorkEffortFontstyle{\color{\TotalWorkEffortFontColor}\\[INSERTTOTALBOTHFTETITLE]}} [INSERTLISTOFANNUALBOTHTOTALS] & \multicolumn{1}{c|}{\color{\TotalWorkEffortFontColor}[INSERTBOTHTOTALOVERYEAR]}\\
