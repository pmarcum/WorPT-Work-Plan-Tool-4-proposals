...
\multicolumn{[INSERTLASTYEARPLUSTHREE]}{|c|}{\cellcolor{\SectionBannerColor}\color{\SectionBannerFontColor}\SectionBannerFontstyle{\FundedFteTitleText}}\\
...
\multicolumn{2}{|l}{\TotalWorkEffortFontstyle{\color{\TotalWorkEffortFontColor}\FteFundedTitleText}} [INSERTLISTOFANNUALFUNDEDTOTALS] & \multicolumn{1}{c|}{\color{\TotalWorkEffortFontColor}[INSERTFUNDEDTOTALOVERYEAR]}\\
...
\arrayrulecolor{lightgray!60}\hline\arrayrulecolor{black}
\multicolumn{2}{|l}{\TotalWorkEffortFontstyle{\color{\TotalWorkEffortFontColor}\FteUnfundedTitleText}} [INSERTLISTOFANNUALUNFUNDEDTOTALS] & \multicolumn{1}{c|}{\color{\TotalWorkEffortFontColor}[INSERTUNFUNDEDTOTALOVERYEAR]}\\
...
\arrayrulecolor{lightgray!60}\hline\arrayrulecolor{black}
\multicolumn{2}{|l}{\TotalWorkEffortFontstyle{\color{\TotalWorkEffortFontColor}\FteBothTitleText}} [INSERTLISTOFANNUALBOTHTOTALS] & \multicolumn{1}{c|}{\color{\TotalWorkEffortFontColor}[INSERTBOTHTOTALOVERYEAR]}\\
