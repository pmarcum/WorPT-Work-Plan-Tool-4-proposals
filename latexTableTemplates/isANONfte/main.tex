...
\def\FaintHorizontalLine{\arrayrulecolor{lightgray!40}} % faint line above summary line
\def\FteFundedSummaryText{Total Funded Work Effort}            % total summary text
...
\FaintHorizontalLine\hline\arrayrulecolor{black}
