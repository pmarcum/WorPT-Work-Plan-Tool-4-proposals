...
%--- caption and label definitions
\def\thisCaption{Details of work efforts per member to be funded for the present proposal; {\color{red}Detailed responsibilities, tied to tasks and science goals, are provided in Sec.\,\ref{Subsec:timeline}.}}
\def\thisLabel{tab:[INSERTFILENAME]}
