...
\def\TaskWidth{4.2in}            % width of "Task" column (leftmost column)
\def\LeadWidth{1.2in}           % width of "Task Lead" column
\def\ExpertiseWidth{1.8in}       % width of "Team Expertise" column (rightmost column)
